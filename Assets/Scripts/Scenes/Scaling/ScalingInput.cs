...
namespace TiltFiveDemos
{
    ...
    public class ScalingInput : BaseDemoInput
    {
        ...
        /// </summary>
        [SerializeField] private TiltFiveManager _tiltFiveManager;
        ...
        {
            Debug.Log("Selecting stop: "+pStop);
        ...
        {
            float result = Mathf.Clamp(Mathf.Log(_tiltFiveManager.scaleSettings.contentScaleRatio, _scaleFunctionPow),_minScale,_maxScale);
        ...
        private void DoScale()
        {
            ...
            _tiltFiveManager.scaleSettings.contentScaleRatio = GetNewScale(_currentScale);
        }
