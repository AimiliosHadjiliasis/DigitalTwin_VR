...
namespace TiltFiveDemos
{
    ...
    public class CylinderScroll : MonoBehaviour
    {
        ...
        public void OnSelected(BaseEventData pEventData)
        {
            ...
            Debug.Log("Button selected in cylinder: " + selectedButton);
        ...
        {
            // Stop and remove the previous rotation.
        ...
        /// <summary>
        /// The cylinder rotation coroutine.
        /// </summary>
        /// <param name="pRotation"></param>
        /// <returns></returns>
        private IEnumerator RotateCoroutine(float pRotation)
        {
            ...
            _cylinder.rotation = Quaternion.Lerp(currentRotation, rotation, _rotationCurve.Evaluate(normal));
