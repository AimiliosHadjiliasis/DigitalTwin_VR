...
namespace TiltFiveDemos
{
    ...
    public class WandPointer : BaseDemoInput
    {
        ...
        protected virtual void DoRaycast(Vector3 pDirection)
        {
            ...
            Vector3 hitPoint = _pointerOrigin.position + (pDirection * 12f);
                ...
                for (int i = 0; i < results.Count; i++)
                {
                    ...
                    if (selectable != null)
                    {
                        ...
                        if (selectable != _currentSelectable)
                        {
                            ...
                            {
                                _currentSelectable.OnDeselect(null);
                                EventSystem.current.SetSelectedGameObject(null); // Make sure the current event system doesn't have this selectable as selected.
                            }
                        ...
                        if(selectable is Button && (Input.GetButtonDown("CursorClick") || _doingClick))
                        {
